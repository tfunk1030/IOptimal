"""Wrapper: run full pipeline with expanded sensitivity + justifications."""
import sys
import os
import io
...
OUTPUT_FILE = os.path.join(ROOT, "full_justified_output.txt")
...
print(f"=== IOptimal Full Justified Pipeline Run ===")
print(f"IBT: {IBT_FILE}")
print(f"Output: {OUTPUT_FILE}")
print(f"Working dir: {os.getcwd()}")
print(f"Search budget: 50000")
print()
